...
# - Obtain the completions and store them in the global __{{ .appName }}_comp_results
...
function __{{ .appName }}_prepare_completions
    ...
    # Start fresh
    set --erase __{{ .appName }}_comp_results
...
# The call to __{{ .appName }}_prepare_completions will setup __{{ .appName }}_comp_results
# which provides the program's completion choices.
complete -c golang-cli-template -n '__{{ .appName }}_prepare_completions' -f -a '$__{{ .appName }}_comp_results'
